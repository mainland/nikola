...
-- |
-- Module      : Data.Vector.CUDA.UnboxedForeign.Base
...
module Data.Vector.CUDA.UnboxedForeign.Base (
  MVector(..), IOVector, STVector, Vector(..), UnboxForeign
) where

import qualified Data.Vector.Generic         as G
import qualified Data.Vector.Generic.Mutable as M

import qualified Data.Vector.CUDA.Storable as P
...
class (G.Vector Vector a, M.MVector MVector a) => UnboxForeign a
...
#if MIN_VERSION_base(4,4,0)
vectorTyCon = mkTyCon3 "nikola"
#else
vectorTyCon m s = mkTyCon $ m ++ "." ++ s
#endif

instance Typeable1 Vector where
  typeOf1 _ = mkTyConApp (vectorTyCon "Data.Vector.CUDA.UnboxForeigned" "Vector") []

instance Typeable2 MVector where
  typeOf2 _ = mkTyConApp (vectorTyCon "Data.Vector.CUDA.UnboxForeigned.Mutable" "MVector") []

instance (Data a, UnboxForeign a) => Data (Vector a) where
  gfoldl       = G.gfoldl
  toConstr _   = error "toConstr"
  gunfold _ _  = error "gunfold"
  dataTypeOf _ = G.mkType "Data.Vector.CUDA.UnboxForeigned.Vector"
...
instance (RealFloat a, UnboxForeign a) => M.MVector MVector (Complex a) where
  {-# INLINE basicLength #-}
  {-# INLINE basicUnsafeSlice #-}
  {-# INLINE basicOverlaps #-}
  {-# INLINE basicUnsafeNew #-}
...
instance (RealFloat a, UnboxForeign a) => G.Vector Vector (Complex a) where
  {-# INLINE basicUnsafeFreeze #-}
  {-# INLINE basicUnsafeThaw #-}
  {-# INLINE basicLength #-}
  {-# INLINE basicUnsafeSlice #-}
