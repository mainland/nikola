...
-- |
-- Module      : Data.Vector.UnboxedForeign.Base
...
instance Typeable1 Vector where
  typeOf1 _ = mkTyConApp (vectorTyCon "Data.Vector.UnboxForeigned" "Vector") []

instance Typeable2 MVector where
  typeOf2 _ = mkTyConApp (vectorTyCon "Data.Vector.UnboxForeigned.Mutable" "MVector") []

instance (Data a, UnboxForeign a) => Data (Vector a) where
  gfoldl       = G.gfoldl
  toConstr _   = error "toConstr"
  gunfold _ _  = error "gunfold"
  dataTypeOf _ = G.mkType "Data.Vector.UnboxForeigned.Vector"
